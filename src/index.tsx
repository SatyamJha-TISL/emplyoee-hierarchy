...
class EmployeeOrgApp implements IEmployeeOrgApp {
    ceo: Employee;
    URCache: cache;
    static readonly DUMMYEMP: Employee = {
        uniqueId: -1,
        name: "Dummy Emp",
        subordinates: [],
    };
    ...
    move(employeeID: number, supervisorID: number): void {
        if (employeeID === this.ceo.uniqueId) {
            console.log(
                "The provided employee ID is of CEO, which is not applicable for this action. Please enter a different employee ID."
            );
            return;
        }
        this.findEmp(this.ceo, supervisorID, employeeID, false, false);
        this.URCache.oldSup.subordinates.splice(
            this.URCache.oldSup.subordinates.indexOf(this.URCache.emp)
        );
...
function printHeirarchy(emp: Employee, tabSpace = ""): void {
    if (tabSpace === "") {
...
const emp11: Employee = {
    uniqueId: 11,
    name: "B3",
    subordinates: [],
};

const emp12: Employee = {
    uniqueId: 12,
    name: "C",
    subordinates: [],
};

const emp13: Employee = {
    uniqueId: 13,
    name: "D",
    subordinates: [],
};

const emp14: Employee = {
    uniqueId: 14,
    name: "D1",
    subordinates: [],
};
